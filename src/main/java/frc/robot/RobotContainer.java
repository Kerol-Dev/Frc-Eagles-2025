...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        driverController.rightBumper().whileTrue(pathFindToAlgae().andThen(new InstantCommand(grabAlgaeCommand::recordPress)));
        driverController.leftTrigger().whileTrue(pathfindToHuman().andThen(IntakeSourceGrabCommand())).onFalse(IdleSystemsCommand());
        driverController.leftBumper().whileTrue(pathfindToProcessor().andThen(DropAlgaeProcessorCommand())).onFalse(IdleSystemsCommand());
