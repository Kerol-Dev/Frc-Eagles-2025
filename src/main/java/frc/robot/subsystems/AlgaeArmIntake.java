...
public class AlgaeArmIntake extends SubsystemBase{
    private final SparkMax AlgaeArmIntakeMotor = new SparkMax(AlgaeArmIntakeConstants.kAlgaeArmIntakeMotorCanID, MotorType.kBrushless);
    ...
    public AlgaeArmIntake(){
        ...
        AlgaeArmIntakeMotor.configure(AlgaeArmIntakeMotorConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    }
